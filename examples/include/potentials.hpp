...
public:
  ...
  //number of mol, box length, charges, position vector, forces vector, electric potential energy
  int elc_pvfmm(int *,double *, vector<double> *, vector<double> *, vector<double> *, double *, MPI_Comm *);
