...
void verlet_par:: Integration_mpi(int *N, int *nsteps, int *showsteps, double *tstep, double *sl, double *sig, double *eps, vector<double> *q, vector<double> *m, vector<double> *pos, vector<double> *vel, MPI_Comm *comm) {
